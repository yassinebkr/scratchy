...
4. **Review and integrate.** When workers return results, verify against the spec. Resolve conflicts between worker outputs. Synthesize the final implementation.
...
4. **Review and harmonize.** When workers return results, verify visual consistency across components. Ensure design tokens are used correctly.
