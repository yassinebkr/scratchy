...
.oauth-btn { flex:1; height:46px; display:flex; align-items:center; justify-content:center; gap:8px; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.08); color:#e8e6e3; font-size:13px; font-weight:500; cursor:pointer; transition:background .15s,border-color .15s; font-family:inherit; }
...
.field input { width:100%; height:46px; padding:0 14px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.08); color:#e8e6e3; font-size:15px; font-family:inherit; transition:border-color .2s,box-shadow .2s; }
...
.strength-bar { flex:1; height:3px; background:rgba(255,255,255,0.06); transition:background .3s; }
.strength-bar.on { background:#F9A602; }
.btn-primary { width:100%; height:46px; background:#F9A602; color:#0a0a0f; border:none; font-size:15px; font-weight:600; cursor:pointer; transition:background .15s; font-family:inherit; display:flex; align-items:center; justify-content:center; gap:8px; }
...
.error { background:rgba(248,113,113,0.08); border:1px solid rgba(248,113,113,0.2); color:#f87171; font-size:13px; padding:10px 14px; margin-bottom:16px; animation:shake .4s; display:none; }
