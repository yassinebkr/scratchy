...
/** Gemini CLI OAuth client credentials — set via env or .env file */
const GEMINI_CLI_CLIENT_ID = process.env.GEMINI_CLIENT_ID || '';
const GEMINI_CLI_CLIENT_SECRET = process.env.GEMINI_CLIENT_SECRET || '';
